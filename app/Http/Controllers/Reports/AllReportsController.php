...
class AllReportsController extends Controller
{
        ...
        $existingLicencesData = array(
            ...
            for($i = 0; $i < count($arr_of_existing_licences); $i++ ){
                    ...
                    $data = [ 
                        ...
                        $arr_of_existing_licences[$i]->application_lodged_at ? date('YY/mm/dd', strtotime($arr_of_existing_licences[$i]->application_lodged_at)) : '',
    ...
    for($i = 0; $i < count($arr_of_new_apps_licences); $i++ ){
            ...
            $data = [ 
                ...
                $arr_of_new_apps_licences[$i]->application_lodged_at ? date('YY/mm/dd', strtotime($arr_of_new_apps_licences[$i]->application_lodged_at)) : '',
