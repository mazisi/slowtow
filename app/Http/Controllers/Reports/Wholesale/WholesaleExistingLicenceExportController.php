...
class WholesaleExistingLicenceExportController extends Controller
{
    public static function export($request){
        $arrayData = array(
            ...
            $arr_of_licences = (new WholesaleExistingLicenceReportFilter)->filter($request)->toArray(); 
        ...
        $data = [ 
                ...
                (new WholesaleExistingLicenceExportController)->getProofOfLodgiment($arr_of_licences[$i]->id) ? 'TRUE': 'FALSE',
                self::getDate($arr_of_licences[$i]->id,'Activation Fee Requested')? self::getDate($arr_of_licences[$i]->id,'Activation Fee Requested'): '',
                '',
