...
class ExistingWholesaleLicenceExportController extends Controller
{
    public static function export($request){
        ...
        $data = [ 
                ...
                '',
                self::getDate($arr_of_licences[$i]->id,'Activation Fee')?self::getDate($arr_of_licences[$i]->id,'Activation Fee'): '',
                ...
                (new ExistingWholesaleLicenceExportController)->getProofOfLodgiment($arr_of_licences[$i]->id) ? 'TRUE': 'FALSE',
                self::getDate($arr_of_licences[$i]->id,'Activation Fee')?self::getDate($arr_of_licences[$i]->id,'Activation Fee'): '',
                '',
                '',
