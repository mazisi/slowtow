...
class WholesaleTransferReportFilter {


  function filter($request){
    return DB::table('licence_transfers')
    ->selectRaw("licence_transfers.id, report_type, is_licence_active,licences.belongs_to, licences.company_id,licences.people_id,trading_name, licence_transfers.date, 
