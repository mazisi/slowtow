...
//   ];
   ...
   public function additionalDocs()
    ...
    function getDuplicateOriginal(Licence $licence){
      
      $doc= $licence->duplicate_originals->each(function($item, $key){
        $item->duplicate_documents->each(function($duplicate_document, $key){
