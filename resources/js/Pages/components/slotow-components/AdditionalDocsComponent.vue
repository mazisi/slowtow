  ...
  <table class="table table-bordered mt-3">
    ...
    <tbody>
      <tr v-if="additional_docs.length > 0" v-for="additional_doc in additional_docs" :key="additional_doc.id">
        ...
        <td v-if="$page.props.auth.has_slowtow_admin_role"> <i @click="deleteDocument(additional_doc.id)" class="cursor-pointer fa fa-trash-alt text-lg text-danger" aria-hidden="true"></i>
        </td>
      </tr>
      <tr v-else >
