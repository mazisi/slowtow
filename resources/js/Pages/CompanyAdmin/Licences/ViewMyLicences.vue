...
<script src="../../Licences/view_licence.js"></script>
                    ...
                    <div class="col-lg-1 col-1 my-auto text-end d-flex">
                        ...
                        <div class="dropdown float-lg-end pe-4">
                            ...
                            <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                                <li v-for="option in campanyMenuOptions" :key="option.id">
                                    <Link :href="`/company/${option.endpoint}?slug=${licence.slug }`" class="dropdown-item border-radius-md">{{ option.name}}</Link>
                                </li>
                                 ...
                                 <div  class="col-md-12 columns">
                                    <div class="input-group input-group-outline null is-filled">
                                        ...
                                        <select v-model="form.licence_type" class="form-control form-control-default">
                                            <option v-for='licence_dropdown in all_licences' disabled :value=licence_dropdown.id> {{ licence_dropdown.licence_type }}</option>
                                        </select>
                                    </div>
                                    <div v-if="errors.licence_type" class="text-danger">{{ errors.licence_type }}</div>
                                </div>
...
Duplicate Original Delivered on the main licence information page.~Dupliacte Original Docs Table~ 
 -->
                            ...
                            <div v-if="!$page.props.auth.has_company_admin_role">
