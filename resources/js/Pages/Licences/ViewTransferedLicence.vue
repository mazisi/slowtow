<script src="./view_transfer.js"></script>
<style>
.columns{
  margin-bottom: 1rem;
}
...
<div class="d-flex justify-content-center w-100">
    ...
    <PrepareTransferApplicationComponent
      ...
      @file-deleted="deleteDocument"
      :documentModel="view_transfer"
      :hasFile="hasFile('Transfer Forms')"
      :errors="errors"
      :error="error"
      stage="400"
...
<div class="d-flex justify-content-center w-100">
    ...
    <PrepareTransferApplicationComponent
      ...
      @file-deleted="deleteDocument"
      :documentModel="view_transfer"
      :hasFile="hasFile('Lease/Landlord Letter')"
      :errors="errors"
      :error="error"
      stage="400"
      belongsTo="Current Licence Holder"
    ...
    <div class="d-flex justify-content-center w-100">
      ...
      @file-deleted="deleteDocument"
      :documentModel="view_transfer"
      :hasFile="hasFile('Representation')"
      :errors="errors"
      :error="error"
      stage="400"
      belongsTo="Old Licence Holder"
...
<div class="d-flex justify-content-center w-100">
    ...
    <PrepareTransferApplicationComponent
      ...
      @file-deleted="deleteDocument"
      :documentModel="view_transfer"
      :hasFile="hasFile('Latest Renewal')"
      :errors="errors"
      :error="error"
      stage="400"
      belongsTo="Current Licence Holder"
