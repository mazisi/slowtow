                                    ...
                                    <ul class="list-group">                                       
                                        ...
                                        <li class="px-0 mb-2 border-0 list-group-item d-flex align-items-center">
                                            <div class="me-3" v-if="duplicate_original_lic">
                                                <a v-if="duplicate_original_lic" :href="`${$page.props.blob_file_path}${duplicate_original_lic.path}`" target="_blank">
                                            ...
                                            <div class="d-flex align-items-start flex-column justify-content-center">
                                                ...
                                                <p v-if="duplicate_original_lic" class="mb-0 text-xs">
                                                    {{ duplicate_original_lic.document_name ? duplicate_original_lic.document_name : '' }}</p>
