<template>
    <ul class="list-group">
        ...
        <div class="d-flex align-items-start flex-column justify-content-center">
          ...
          <p v-if="hasFile" class="mb-0 text-xs limit-file-name">
            {{ hasFile.document_name }}</p>
          <p v-else class="mb-0 text-xs text-danger fst-italic">Document Not Uploaded.</p>
        </div>
        <button  v-if="hasFile" @click="deleteDocument(hasFile.path)" type="button" class="mb-0 btn btn-link pe-10 ps-0 ms-auto">
